              ...
              body: Center(
                child: Column(
                    ...
                    children: [
                      ...
                      Text("Click to copy:", style: TextStyle(color: MediaQuery.of(context).platformBrightness != Brightness.light ? Colors.white : Colors.black, fontSize: MediaQuery.of(context).size.height * 0.036)),
                      TextButton(
                        style: TextButton.styleFrom(foregroundColor: MediaQuery.of(context).platformBrightness != Brightness.light ? Colors.white : Colors.black, textStyle: TextStyle(fontSize: MediaQuery.of(context).size.height * 0.036)),
                        onPressed: () async {
