...
class _AdaptiveSettingsPageState extends State<AdaptiveSettingsPage> {
  ...
  _readDB() async {
    ...
    multipleChoiceQuestions =
        Wrapper(db[0]['multipleChoiceQuestions'].toString());
                    ...
                    appBar: BetterAppBar(
                      ...
                      PreferredSize(
                        ...
                        child: LinearProgressIndicator(
                          value: value,
                          semanticsLabel:
                              "Indicates loading while communicating with database",
                        ),
                      ),
                    ),
                    body: ListView(children: [
                      Padding(
                        ...
                        child: Column(children: [
                          const Text("What to study?",
                              semanticsLabel: "What to study?",
                              style: TextStyle(
                            ...
                            child: DropdownButton(
                              ...
                              items: [
                                ...
                                return DropdownMenuItem<String>(
                                  value: value,
                                  child: Text(value, semanticsLabel: value),
                                );
                              }).toList(),
                              onChanged: (value) async {
                                ...
                                await LocalDatabase.updateAdaptiveSettings(
                                    1, dropdownPosition);
                              },
                              isExpanded: true,
                              style: TextStyle(
                      ...
                      Center(
                        child: Card(
                          color:
                              multipleChoiceEnabled ? Colors.green : Colors.red,
                          elevation: 4,
                            ...
                            child: SizedBox(
                              ...
                              child: Padding(
                                  padding: EdgeInsets.fromLTRB(
                                      ...
                                      0),
                                  child: Text(
                                      "Multiple Choice ${multipleChoiceEnabled ? "Enabled" : "Disabled"}",
                                      semanticsLabel:
                                          "Multiple Choice ${multipleChoiceEnabled ? "Enabled" : "Disabled"}",
                            ...
                            child: SizedBox(
                              ...
                              child: Padding(
                                  padding: EdgeInsets.fromLTRB(
                                      ...
                                      0),
                                  child: Text(
                                      "Writing ${writingEnabled ? "Enabled" : "Disabled"}",
                                      semanticsLabel:
                                          "Writing ${writingEnabled ? "Enabled" : "Disabled"}",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                      ...
                      BetterTextFormFieldNumbersOnly(
                      ...
                      BetterTextFormFieldNumbersOnly(
                          ...
                          "Each question will stay in the group until you master it",
                          null,
                          null,
                          repeatQuestions,
                          repeatQuestions.object,
                          null,
                          6),
                      const Padding(
                        padding: EdgeInsets.only(top: 20),
                        ...
                        showDialog<String>(
                          ...
                          builder: (BuildContext context) => AlertDialog(
                            title: const Text(
                              ...
                              semanticsLabel: "Are you sure you want to reset?",
                            ),
                            content: const Text(
                              'This will reset all of your current progress!',
                              semanticsLabel:
                                  "This will reset all of your current progress!",
                            ),
                            actions: <Widget>[
