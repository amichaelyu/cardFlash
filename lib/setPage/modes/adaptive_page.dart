  ...
  _updateCounter(int valueUpdate) async {
    ...
    if (counter == (shuffledList.length - 1)) {
      ...
      for (int i = shuffledList.length; i < len; i++) {
        if (!shuffledList.contains(randomList[i])) shuffledList.add(randomList[i]);
      }
      shuffledList.shuffle();
      counter = 0;
    }
                                      ...
                                      onTap: () async {
                                        ...
                                        if (showAnswer != true) {
                                          ...
                                          if (colorList[i] != Colors.green) {
                                            ...
                                            LocalDatabase.resetCorrectInARow(shuffledList[counter]-1, answers.last);
                                            mess.showSnackBar(
                                              const SnackBar(
                                                backgroundColor: Colors.black87,
                                                content: Text(
                                                  'Incorrect! Click any answer to move on!',
                                                  semanticsLabel: "Incorrect! Click any answer to move on!",
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                  ),
                                                ),
                                            ...
                                            mess.showSnackBar(
                                              const SnackBar(
                                                ...
                                                content: Text(
                                                  ...
                                                  semanticsLabel: "Correct! Click any answer to move on!",
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                  ),
                                                ),
                  ...
                  onPressed: () async {
                    ...
                    if ((writingVal.object == null || writingVal.object.trim() == "") && nullCounter == 0) {
                      ...
                      if (nullCounter != 0 || !correct) {
                        ...
                        await LocalDatabase.resetCorrectInARow(shuffledList[counter]-1, answers.last);
                        mess.showSnackBar(
                          SnackBar(
                        ...
                        mess.showSnackBar(
                          const SnackBar(
                            ...
                            content: Text(
                              ...
                              semanticsLabel: "Correct! Click the button again to move on!",
                              style: TextStyle(
                                color: Colors.white,
                              ),
                            ),
                      ...
                      showAnswer = true;
                      if (nullCounter == 0 && (await SharedPreferences.getInstance()).getBool("adaptiveInstant")! && correct) {
                        nullCounter = 0;
                        maintainW = false;
                        showAnswer = false;
                        writingController.clear();
