...
class BetterCardInstant extends StatelessWidget {
  final String title;
  final Function()? action;
  final Color? color;

  const BetterCardInstant(this.title, this.action, this.color, {super.key});
...
class Folder {
  ...
  Folder(this.position, this.title, this.desc);

  @override
  String toString() {
    return 'Folder{id: $position, title: $title, desc: $desc}';
  }
}
